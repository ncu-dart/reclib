...
# Last Modified: Sun 04 Feb 2018 03:46:15 PM CST
...
def main(argv):
    ...
    rec = reclib.RVSVD(n_users=n_users, n_items=n_items)
    rec.train(X)

    dump_filename = os.path.splitext(os.path.basename(argv[1]))[0] + '-rvsvd-model.pck'
